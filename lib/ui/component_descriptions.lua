...
return {
  ...
  COMPOSER_CYCLING = "Cycling chord progression generator.\n\nFlavor presets set the Movement interval. Adjust Start degree and Movement to reshape the cycle.\n\nDiatonic quality follows the scale; fixed qualities override.\n\nTexture controls (chord length, voicing, rotation, strum) color the voicing without changing the progression.\n\nChanges land at the next loop boundary via regen.",
