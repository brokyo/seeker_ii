...
local function create_grid_ui()
  ...
  grid_ui.draw = function(self, layers)
    ...
    local is_stage_config_section = (_seeker.ui_state.get_current_section() == "SAMPLER_STAGE_CONFIG")
    local selected_config_stage = params:get("lane_" .. focused_lane_id .. "_sampler_config_stage")
  ...
  grid_ui.handle_key = function(self, x, y, z)
    if z == 1 then
      ...
      params:set("lane_" .. focused_lane_id .. "_sampler_config_stage", stage_num)
