-- perform.lua
-- Composer motif performance controls
...
local SECTION_ID = "COMPOSER_PERFORM"

local function get_param_prefix(lane_id)
  return "lane_" .. lane_id .. "_composer_performance"
end
...
local function create_params()
  for i = 1, 8 do
    ...
    PerformEngine.create_params_for_lane(i, prefix, "LANE " .. i .. " COMPOSER PERFORMANCE", rebuild_callback)
  end
end
