-- playback.lua
-- Composer type: motif playback control
...
local function create_screen_ui()
  ...
  norns_ui.draw_default = function(self)
    ...
    if _seeker.ui_state.is_long_press_active() and _seeker.ui_state.get_long_press_section() == "COMPOSER_PLAYBACK" then
      screen.level(15)
    else
      screen.level(2)
    end
...
local function create_grid_ui()
  ...
  grid_ui.draw = function(self, layers)
    ...
    elseif _seeker.ui_state.get_current_section() == "COMPOSER_PLAYBACK" then
  ...
  grid_ui.handle_key = function(self, x, y, z)
    ...
    if z == 1 then -- Key pressed
      ...
      _seeker.ui_state.set_current_section("COMPOSER_PLAYBACK")
      _seeker.ui_state.set_long_press_state(true, "COMPOSER_PLAYBACK")
...
function ComposerPlayback.init()
  local component = {
